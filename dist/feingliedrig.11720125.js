(function() {
    ...
    const baseContent1 = document.getElementById("base-content");
    ...
    class FoldedDom {
        ...
        generateFolds(baseContent, foldCount) {
            ...
            this.centerFold = rightFolds.folds[Math.floor(leftFolds.folds.length / 2)];
    ...
    let tick = ()=>{
        ...
        document.body.style.height = foldedDomCenter.centerFold.children[0].children[0].clientHeight + -foldedDomCenter.centerFold.clientHeight + window.innerHeight + "px";
        ...
        foldedDomCenter.updateStyles(progress + baseContent1.offsetTop);
    ...
    preloadImages().then(()=>{
        ...
        const foldCount = 1;
        foldedDomCenter.generateFolds(baseContent1, foldCount);
        tick();
    });
})();

//# sourceMappingURL=feingliedrig.11720125.js.map
